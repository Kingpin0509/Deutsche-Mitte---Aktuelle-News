...
ionic cordova platform rm ios && ionic cordova platform rm android && ionic cordova platform rm windows && ionic cordova platform rm browser && ionic cordova platform add ios && ionic cordova platform add android && ionic cordova platform add windows && ionic cordova prepare && ionic cordova resources && ionic package build android --profile=prod --release --prod && ionic package build ios --profile=prod --release --prod && ionic build  && ionic upload